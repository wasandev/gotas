...
<div class="flex items-center py-16">
    <div class="md:w-1/2 md:mx-auto m-4">
        <div class="rounded shadow">
            <div class="font-medium text-lg text-white bg-blue p-4 rounded-t">
            ...
            <div class="bg-white p-4 rounded-b">
                ...
                <p class="text-gray-darkest">
                    ...
                    {{ __('ถ้าหากคุณยังไม่ได้รับอีเมลจากเรา ') }}, <a href="{{ route('verification.resend') }}"
                    class="no-underline text-danger hover:text-black ">
