        ...
        <div :class="open ? 'block': 'hidden'" class="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
            <div class="text-xl lg:flex-grow text-center">
                <a href="#responsive-header"
                    class="block mt-2 lg:inline-block lg:mt-0 text-gray-darkest hover:text-mstore mr-4">
                    Docs
                </a>
                <a href="#responsive-header"
                    class="block mt-2 lg:inline-block lg:mt-0 text-gray-darkest hover:text-mstore mr-4">
            ...
            <div>
                ...
                <div class="relative group items-center text-center">
                    <div
                        class="flex items-center cursor-pointer text-xl text-grey-lighter  group-hover:border-mstore hover:text-mstore  mt-1 px-6 mb-0 sm:mt-0">
                    ...
                    <div
                        ...
                        <a href="{{ route('logout') }}"
                            class=" no-underline px-4 py-2 block text-grey-darkest hover:bg-grey-lighter" onclick="event.preventDefault();
                ...
                <a href="{{ route('login') }}"
                    class="no-underline inline-block text-xl font-semibold px-4 py-2 leading-none text-grey-lighter rounded hover:text-white hover:bg-mstore  mt-4 sm:mt-0">
