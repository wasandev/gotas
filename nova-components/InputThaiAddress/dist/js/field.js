...
Nova.booting(function (Vue, router) {
    ...
    //sub-district
    Vue.component('index-input-sub-district', __webpack_require__(5));
    Vue.component('detail-input-sub-district', __webpack_require__(8));
    Vue.component('form-input-sub-district', __webpack_require__(11));

    //district
    Vue.component('index-input-district', __webpack_require__(15));
    Vue.component('detail-input-district', __webpack_require__(18));
    Vue.component('form-input-district', __webpack_require__(21));

    //province
    Vue.component('index-input-province', __webpack_require__(24));
    Vue.component('detail-input-province', __webpack_require__(27));
    Vue.component('form-input-province', __webpack_require__(30));

    //postal-code
    Vue.component('index-input-postal-code', __webpack_require__(33));
    Vue.component('detail-input-postal-code', __webpack_require__(36));
    Vue.component('form-input-postal-code', __webpack_require__(39));
});
