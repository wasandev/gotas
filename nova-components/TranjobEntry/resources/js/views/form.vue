      ...
      <div class="row">
        <div class="col-12">
          <div class="form-group">
            ...
            <small class="error-control" v-if="errors.customer_id">{{errors.customer_id[0]}}</small>
          </div>
        </div>
        <div class="col-6">
          <div class="form-group">
        ...
        <div class="col-6">
          <div class="form-group">
            ...
            <small class="error-control" v-if="errors.reference">{{errors.reference[0]}}</small>
          </div>
        </div>
      </div>
      <div class="row">
        <div class="col-6">
          <div class="form-group">
            ...
            <small class="error-control" v-if="errors.date">{{errors.date[0]}}</small>
          </div>
        </div>
        <div class="col-6">
          <div class="form-group">
            ...
            <small class="error-control" v-if="errors.due_date">{{errors.due_date[0]}}</small>
          </div>
        </div>
      </div>
      <hr />
        ...
        <tbody>
          <tr v-for="(item, index) in form.items">
            ...
            <td class="w-2">
              ...
              >{{errors[`items.${index}.qty`][0]}}</small>
            </td>
            <td class="w-4">
              <span
                class="form-control"
              >{{Number(item.qty) * Number(item.unit_price) | formatMoney}}</span>
            </td>
            <td>
        ...
        <tfoot>
          ...
          <tr>
            ...
            <td>
              ...
              <small class="form-control" v-if="errors.discount">{{errors.discount[0]}}</small>
            </td>
          </tr>
          <tr>
      ...
      <div class="row">
        <div class="col-12">
          <div class="form-group">
            ...
            >{{errors.terms_and_conditions[0]}}</small>
          </div>
        </div>
      </div>
    </div>
...
function initialize(to) {
  let urls = {
    create: `/api/tranjobs/create`,
    edit: `/api/tranjobs/${to.params.id}/edit`
  };
  ...
  methods: {
    setData(res) {
      ...
      if (this.$route.meta.mode === "edit") {
        this.store = `/api/tranjobs/${this.$route.params.id}`;
        this.method = "PUT";
        this.title = "Edit";
      }
