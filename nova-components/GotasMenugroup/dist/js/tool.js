...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    getToolConfig: function getToolConfig() {
      ...
      Nova.request().get("/nova-vendor/gotas-menugroup").then(function (_ref2) {
        var data = _ref2.data;

        _this.toolConfig = data;
      });
    }
  },
  ...
  computed: {
    ...
    group: function group() {
      ...
      return _.find(Nova.config.resources, function (r) {
        return r.groupSlug === _this2.groupSlug;
      }).group;
    },
    resources: function resources() {
      ...
      return _.filter(Nova.config.resources, function (r) {
        return r.groupSlug === _this3.groupSlug && r.subGroup;
      });
    },
    sections: function sections() {
      ...
      _.forEach(sections, function (s) {
        ...
        s.resources = _.filter(_this4.resources, function (r) {
...
var render = function() {
  ...
  return _c(
    "div",
    [
      _c("heading", { staticClass: "mb-6" }, [_vm._v(_vm._s(_vm.group))]),
      _vm._v(" "),
      _c(
        "div",
        { staticClass: "flex flex-wrap -mx-3" },
        _vm._l(_vm.sections, function(section) {
          return _vm.config.width
            ? _c(
                "div",
                { staticClass: "px-3 mb-6", class: _vm.width },
                [
                  _c(
                    "loading-card",
                    { staticClass: "px-6 py-4", attrs: { loading: false } },
                    [
                      _c(
                        "h3",
                        {
                          staticClass: "flex mb-3 text-base text-80 font-bold"
                        },
                      ...
                      _c(
                        "div",
                        { staticClass: "overflow-hidden overflow-x-auto" },
                        [
                          _c(
                            "ul",
                            { staticClass: "list-reset" },
                            _vm._l(section.resources, function(resource) {
                              return _c(
                                "li",
                                { staticClass: "text-lg leading-normal pb-1" },
                                [
                                  _c(
                                    "router-link",
                                    {
                                      staticClass:
                                        "no-underline text-primary dim",
                                      attrs: {
                                        to: {
                                          name: "index",
                                          params: {
