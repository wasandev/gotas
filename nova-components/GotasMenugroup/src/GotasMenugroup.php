...
class GotasMenugroup extends Tool
{
    /**
    ...
    {
        Nova::script('gotas-menugroup', __DIR__ . '/../dist/js/tool.js');
        Nova::style('gotas-menugroup', __DIR__ . '/../dist/css/tool.css');
    }
    ...
    {
        return view('gotas-menugroup::navigation');
    }
